    ...
    <>
      ...
      <a.div style={mainMenuSpring} className="w-full h-full fixed">
        <div className="w-[40%] portrait:w-[80%] backdrop-blur-lg h-auto fixed bg-zinc-900/50 rounded-xl left-0 right-0 top-20 m-auto">
          <div className={`text-center m-4 ${poppins.className}`}>
          ...
          <div className="m-4">
            <form className="w-[90%]">
              <div className="grid-cols-2 grid gap-2">
                <Icon icon="material-symbols:key" className="text-4xl w-full" />
                <code>
                  <input
                ...
                <Icon
                  ...
                  className="text-4xl inline w-full"
                  inline={true}
                />
                {/* resizable input box */}
                <code>
