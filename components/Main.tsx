...
const Main = () => {
  ...
  // todo: deprecated
  const [languageSprings, setLanguageSprings] = useSprings(
    languages.length,
    () => ({
      scale: 1,
    }),
    ...
    <>
      ...
      <a.div style={loadSpring} className="fixed w-full h-full">
        <a.div style={backgroundSpring}>
          <Background setReady={setLoadedImages} image={images[0]} />
        </a.div>
        ...
        <a.div style={mainMenuSpring} className="w-full h-full fixed">
          <div className="w-[40%] portrait:w-[80%] h-auto fixed bg-zinc-900/75 rounded-xl left-0 right-0 top-20 m-auto">
            <div className="text-center m-4">
              ...
              />
              <p
                className={`text-zinc-300 text-xl mt-4 mb-4 ${poppins.className}`}
              >
                {splashText}
              </p>
            ...
            <div className="right-0 absolute -top-2 select-none">
              <a href="https://nextjs.org" rel="noreferrer" target="_blank">
                ...
                <svg
                  ...
                  className="fixed right-0 mr-[180px] w-20 bottom-1"
                  fill="none"
                  viewBox="0 0 394 80"
                >
                  <path
              ...
              <span className="relative top-[6.5px]">
