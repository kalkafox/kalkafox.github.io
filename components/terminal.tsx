...
const Terminal = () => {
    ...
    useEffect(() => {
        if (terminal && terminalReady && terminalRef.current) {
            ...
            terminal.write("You will die within these dunes... Is that how it's said?\r\n>")
    ...
    return (
        <>
            <div className="bottom-0 top-0 h-80 fixed left-0 right-0 m-auto w-[600px]" ref={terminalRef}></div>
        </>
    )
}
